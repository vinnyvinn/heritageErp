...
page(_($help_context = "Lot Item GRN Listing"), false, false, "", $js);
...
{
  return pager_link( _("Generate Lot#"),
	"/purchasing/lot_receive_items.php?PONumber=" . $row["order_no"].'&POItem='.$row["po_detail_item"], ICON_RECEIVE);
}
