...
function defaultCompany()
{
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/erp.png' alt='WizERP' class='logo-erp' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
